...
<div class="container">
      ...
      <div class=" text-center">
                ...
                <br>
                <p class="lead">
              Ajouter et lister les semestres de votre université
    ...
    <div class="row justify-content-center">
        <div class="col-md-6">
                ...
                <div class="card">
                  ...
                  <form class="needs-validation" method="POST" action="{{ route('semestre.store') }}">
                            ...
                            {!! csrf_field() !!}
                                ...
                                <div class="col-md-8 mb-3">
                                  ...
                                  <input name="semestre" type="text" class="form-control" id="" placeholder="" value="" >
